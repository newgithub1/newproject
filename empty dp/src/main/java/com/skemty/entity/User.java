...
public class User implements Serializable, UserDetails {
	...
	public String getskemtyAddress() {
		return skemtyAddress;
	}

	public void setskemtyAddress(String skemtyAddress) {
		this.skemtyAddress = skemtyAddress;
	}
	...
	public String toString() {
		return "User [id=" + id + ", token=" + token + ", userName=" + userName + ", skemtyAddress=" + skemtyAddress
