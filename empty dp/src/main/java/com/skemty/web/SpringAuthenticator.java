...
/**
 * This is the authentication implementation for the Admin app. It implements
 * the Spring UserDetails service to retrieve user information from SimpleDB.
 */
public class SpringAuthenticator implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException, DataAccessException {
		...
		UserDetails details = adminManager.getUser(username);
